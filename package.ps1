...
function Update-Version {
    ...
    $jsonOutput = $packageJson | ConvertTo-Json -Depth 100 -Compress:$false
    $jsonOutput = $jsonOutput -replace ',\s*([}\]])', ' $1'
    [System.IO.File]::WriteAllText($packageJsonPath, $jsonOutput, [System.Text.Encoding]::UTF8)
    return $newVersion
}
